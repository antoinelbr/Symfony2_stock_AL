 ...
 */
class Inventory extends \AppBundle\Entity\Inventory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Inventory' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Inventory' . "\0" . 'quantity', '' . "\0" . 'AppBundle\\Entity\\Inventory' . "\0" . 'price', '' . "\0" . 'AppBundle\\Entity\\Inventory' . "\0" . 'product', '' . "\0" . 'AppBundle\\Entity\\Inventory' . "\0" . 'inventoryOperations');
        }
    ...
    public function addInventoryOperation(\AppBundle\Entity\InventoryOperation $inventoryOperations)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addInventoryOperation', array($inventoryOperations));

        return parent::addInventoryOperation($inventoryOperations);
    }
